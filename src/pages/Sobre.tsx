        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700">
                ...
                frescos, massa artesanal e um amor genuíno por reunir pessoas ao
                redor de uma boa mesa.
              </p>
            </div>
            <div>
              <img
                src="/public/images/pizza-margherita.png"
                alt="Pizza deliciosa da Mira's"
          ...
          <section className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-lg shadow-md border border-gray-200">
                ...
                <p className="text-gray-600">
                  Nossa missão é proporcionar momentos deliciosos com um serviço
          ...
          <section className="text-center bg-red-700 text-white py-12 px-6 rounded-lg">
            ...
            <p className="text-lg mb-6 max-w-2xl mx-auto">
              Seja no nosso salão, pelo delivery ou retirando no balcão, temos a
              pizza perfeita esperando por você.
            </p>
            <a
